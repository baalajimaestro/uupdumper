...
RUN apt install git python3 moreutils openssh-client openssh-server curl wget python3-pip aria2 zip unzip cabextract wimtools chntpw genisoimage grep bash openssl ca-certificates -y > /dev/null
